...
if (isset($_GET['p_id']) && $_GET['p_id'] != '') {
    ...
    $level1 = $data['uplevel'];
    $level1Open = ' <li class="breadcrumb-item"><a href="producestore.php?classid=' . $level1Upclassid  . '&level=' . $level1 . '" >' . $level1Cname . '</a></li>';
    //處理第二層
    $level2Cname = $data['cname'];
    $level2Classid = $data['classid'];
    $level2Open = ' <li class="breadcrumb-item"><a href="producestore.php?classid=' . $level2Classid . '">' . $level2Cname . '</a></li>';
    //處理第三層
    ...
    $level1Cname = $data['cname'];
    $level1 = $data['level'];
    $level1Open = ' <li class="breadcrumb-item"><a href="producestore.php?classid=' . $level2Uplink  . '&level=' . $level1 . '" >' . $level1Cname . '</a></li>';
}
?>
