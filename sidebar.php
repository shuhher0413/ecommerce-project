<div class="sidebar">
    <?php  ?>
    <form name="search" id="search" action="producestore.php" method="get">
                    ...
                    <table class="table">
                        <tbody>
                            <?php while ($pyclass02_Rows = $pyclass02->fetch()) { ?>
                                <tr>
                                    <td><a href="producestore.php?classid=<?php echo $pyclass02_Rows['classid']; ?>"><em class="fas <?php echo $pyclass02_Rows['classid']; ?> fa-fw"></em><?php echo $pyclass02_Rows['cname']; ?></a></td>
                                <tr>
                                <?php } ?>
                        </tbody>
                    </table>
